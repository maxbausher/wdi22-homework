...
Store.destroy_all
store1 = Store.create name: "Porters Liqour",address: "404 Sydney Rd, Balgowlah, NSW, 2093"
store2 = Store.create name: "Beer Cartel",address: "9/87 Reserve Rd, Artarmon, NSW, 2064"
store3 = Store.create name: "Camperdown Cellars",address: "64 Clark Rd, Neutral Bay, NSW, 2060"


store1.beers << beer1 << beer3
store2.beers << beer2 << beer5
store3.beers << beer4 << beer6
